/*
 Provides a simple block-based API
 to perform a search and return a FlickrSearchResult.
 */
...
class FlickrPhoto: Equatable {
    ...
    lazy var url = "https://live.staticflickr.com/\(server)/\(photoID)_\(secret)_m.jpg"
